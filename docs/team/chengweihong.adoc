...
=== Enhancement Proposed: Use of natural language to process input command.

==== Justification

To allow for more flexible commands input so that the user does not have to enter commands in a specific form.
...
* Tag colors are now assigned without repetition unless the list of colors are used. (Pull requests https://)
